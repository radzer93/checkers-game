...
public class Ranking implements Serializable {
    ...
    private File file = new File("ranking.bin");
    ...
    private void saveRanking() {
        try {
            ...
            dateLastGame = simpleDateFormat.format(date);

            ObjectOutputStream objectOutputStream = new ObjectOutputStream(new FileOutputStream(file));
            objectOutputStream.writeObject(ranking);
            objectOutputStream.writeObject(dateLastGame);
    ...
    private void loadRanking() {
        try {
            ...
            Object readList = objectInputStream.readObject();
            Object readDate = objectInputStream.readObject();
